...
<h3><u>Early Time Frame RB-ETF</u></h3>
...
st2.executeUpdate("delete from f4");
st2.executeUpdate("ALTER TABLE f4 AUTO_INCREMENT=1");
while(rs.next())
	{
%>
              ...
              <tbody>
                <tr>
				  ...
				  <td><%=rs.getString("date_")%><%double d1=EarlyTimeFrame.score(rs.getString("userid"),rs.getString("prodid"),tab);
					%></td>
					<td><%String res=EarlyTimeFrame.main(rs.getString("userid"),rs.getString("prodid"),tab);
if(res.equals("Spam"))
{String sql1 = "INSERT INTO f4(f4) " + "VALUES (1)";
    	st3.executeUpdate(sql1);	
out.println("<font color=red>"+res+"</font>");}

else{String sql1 = "INSERT INTO f4(f4) " + "VALUES (0)";
    st3.executeUpdate(sql1);	
